...
class Options:
    def __init__(self):
        ...
        self.parser.add_argument(
            "--pad_tiles",
            type=bool,
            help="whether to pad the tiles up to num_tiles if #tiles is smaller than num_tiles",
        )
        ...
        self.parser.add_argument(
            "--lr_scheduler_config", action=DictionaryAction, help="further lr_scheduler configurations"
        )
        ...
        self.parser.add_argument(
            "--val_check_interval", type=int, default=500, help="interval to evaluate on validation set"
        )
