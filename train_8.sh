...
torchrun --nproc_per_node=8 /home/icb/valentin.koch/dinov2/dinov2/train/train.py --name "vits8_hema_w_mil_mll" --output_dir "" --config-file /home/icb/valentin.koch/dinov2/dinov2/configs/train/custom_8.yaml
